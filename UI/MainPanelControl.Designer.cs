namespace WordTool.UI
{
    partial class MainPanelControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnRunAll.Height = 48;
            this.btnRunAll.Text = "开始一键全自动排版";
            this.btnRunAll.Click += new System.EventHandler(this.btnRunAll_Click);

            // tabPageManual
            this.tabPageManual.Controls.Add(this.btnLayout);
            this.tabPageManual.Controls.Add(this.btnTable);
            this.tabPageManual.Controls.Add(this.btnImage);
